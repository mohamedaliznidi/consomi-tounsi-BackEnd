...
import  tn.esprit.spring.entities.Address;
...
public class GeocodeService {
	 ...
	 * @return
	 */
	public LatLng getGeocode(Deliveryman shop) {
	 ...
	 * @return
	 */
	private String getFormattedAddress(Deliveryman shop) {
		Address address = shop.getShop1().getDeliveryAddress();
		StringBuilder formattedAddress = new StringBuilder();
		if (Objects.nonNull(shop.getShop1().getDeliveryName())) {
			formattedAddress.append(shop.getShop1().getDeliveryName()).append(",");
		}
